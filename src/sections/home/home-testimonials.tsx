    ...
    <Stack sx={{ py: { xs: 5, md: 8 }, position: 'relative' }}>
      ...
      >
        {[
          ...
          { label: 'Completed Orders', value: 200 },
          { label: 'Review rate', value: 4.5 },
        ].map((item) => (
              ...
              <AnimateCountUp
                ...
                unit={
                  item.label === 'Happy Customers'
                    ? 'k+'
                    : item.label === 'Completed Orders'
                      ? 'k+'
                      : '+'
                }
                toFixed={item.label === 'Review rate' ? 1 : 0}
                sx={[
                  (theme) => ({
...
const TESTIMONIALS = [
  {
    ...
    content: `Excellent window cleaner, very professional work.`,
    postedAt: 'January 12, 2026 10:30:00',
  },
  {
    ...createReview(2),
    category: 'Renovation',
    content: `I am extremely satisfied with both the end result and the service! Full marks.`,
    postedAt: 'January 11, 2026 14:15:00',
  },
  {
    ...createReview(3),
    category: 'Property Maintenance',
    content: `Regarding deck construction - professional work and excellent communication throughout the project.`,
    postedAt: 'January 10, 2026 09:45:00',
  },
  {
    ...createReview(4),
    category: 'Renovation',
    content: `Help with investment property renovation - the team was skilled and delivered on time.`,
    postedAt: 'January 9, 2026 16:20:00',
  },
  {
    ...createReview(5),
    category: 'Cleaning Service',
    content: `The job was done on time and professionally. I highly recommend!`,
    postedAt: 'January 13, 2026 11:00:00',
  },
  {
    ...createReview(6),
    category: 'Customer Service',
    content: `Excellent service from start to finish. I will definitely use again.`,
    postedAt: 'January 12, 2026 15:30:00',
  },
  {
    ...createReview(7),
    category: 'Roof Repairs',
    content: `Quick response to roof damage. Professional assessment and quality repairs.`,
    postedAt: 'January 8, 2026 13:45:00',
  },
  {
    ...createReview(8),
    category: 'HVAC Service',
    content: `Excellent HVAC service. The technician was knowledgeable and thorough.`,
    postedAt: 'January 7, 2026 10:15:00',
  },
];
